 ...
 * カメラ撮影用フラグメント
 */
@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP) public class CameraFragment extends Fragment
  ...
  private void transformTexture(int viewWidth, int viewHeight) {
    ...
    // プレビュー領域を示す矩形
    RectF bufferRect = new RectF(0, 0, mCameraInfo.getPictureSize().getHeight(),
